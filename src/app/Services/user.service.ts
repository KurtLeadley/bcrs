...
export class UserService {
 ...
 /*  private email: string;
  ...
  createUser(userId:string, password: string, firstName:string, lastName:string,
    address:string, email:string) {
    // build our question in Question form
    const newUser: User = {userId:userId, password:password, firstName:firstName,lastName:lastName,
